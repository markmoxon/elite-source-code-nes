...
config.set_inline_comment_column(25)
...
for x in range(0, 320):
    byte(0x8100 + x * 16, 16)
    hexadecimal(0x8100 + x * 16, 16)
    label(0x8100 + x * 16, "tile3_{0:X}".format(x))
    binary(0x8100 + x * 16, 16)

byte(0x95CE, 0xA7B6 - 0x95CE)
hexadecimal(0x95CE, 0xA7B6 - 0x95CE)
